...
const dashboardList = [
  {
    ...
    href: "/dashboard",
    description:
      "Общие показатели по пользователям и активности.",
  },
  {
    title: "Пользователи",
    href: "/users",
    description:
      "Таблица юзеров с их ролями, балансом и остальными данными.",
  },
  {
    title: "Логи и статистика",
    href: "/logs",
    description:
      "История событий, аналитика активности и мониторинг.",
  },
];
...
const commandsList = [
  {
    ...
    description:
      "Команды для запуска викторин и игровых механик (кейсы, мини-игры).",
  },
  {
    title: "Инвентарь и баланс",
    href: "/commands/inventory",
    description:
      "Просмотр предметов, открытие кейсов, проверка и перевод баланса.",
  },
  {
    title: "Помощь и справка",
    href: "/commands/helper",
    description:
      "Команды для получения справки, информации о боте и обратной связи.",
  },
  {
    title: "Админские команды",
    href: "/commands/admin",
    description:
      "Настройка викторин, кейсов, предметов, прав доступа, логов и аналитики.",
  },
];
...
const casesList = [
  {
    ...
    href: "/cases",
    description:
      "Наполнение и вероятность выпадения предметов.",
  },
  {
    title: "Настройка предметов",
    href: "/cases/items",
    description:
      "Параметры предметов внутри кейсов: название, тип (роль, валюта, тд).",
  },
  {
    title: "История открытий",
    href: "/cases/history",
    description:
      "Записи о том, когда и какие кейсы были открыты пользователями.",
  },
];
...
const quizList = [
  {
    ...
    href: "/quiz/overwatch",
    description:
      "Управление вопросами, вероятностями и наградами за ответы.",
  },
  {
    title: "Другой ивент",
